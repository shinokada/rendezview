(function ($, w, undefined) {
	...
	var defaults = {
		...
		// firstText: '<span class="glyphicon glyphicon-chevron-left">&nbsp;First</span>',
		firstText: '&laquo;',
		previousText: '&lsaquo;',
		// previousText: '<span class="glyphicon glyphicon-backward">&nbsp;Previous</span>',
		// nextText: '<span class="glyphicon glyphicon-foward">&nbsp;Next</span>',
		nextText: '&rsaquo;',
		lastText: '&raquo;',
		// lastText: '<span class="glyphicon glyphicon-chevron-right">&nbsp;Last</span>',
		limitNavigation: 0,
		limitPreviousText: '...',
		limitNextText: '...'
	};
